...
The current verified catalog inventory and disposition is recorded in `docs/AI-DOS/Architecture/Reports/AI-DOS-Template-Library-Filesystem-Inventory-and-Disposition.md`. Catalog presence does not imply normalized-family or active-component status.
