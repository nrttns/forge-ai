...
| Traceability ID | AI-DOS.TEMPLATES.WORKFLOW.DECISION |
...
Use this template for workflow, process, execution, tooling, or governance-routing decisions. Use `docs/AI-DOS/Templates/Architecture/ADRTemplate.md` for architecture decisions.
