...
| Dependencies | `docs/AI-DOS/Templates/TemplateLibrary.md`; `docs/AI-DOS/Templates/TemplateIndex.md`; `docs/AI-DOS/Templates/Workflow/WorkflowFamily.md`; TPL-000; STD-010 when applicable; declared owning authority. |
