...
| Related Specifications | `docs/AI-DOS/Templates/Architecture/ADRTemplate.md`; `docs/AI-DOS/Templates/Architecture/ArchitectureTemplate.md`; `docs/AI-DOS/Templates/Architecture/GovernanceTemplate.md`; `docs/AI-DOS/Templates/Architecture/RFCTemplate.md`; `docs/AI-DOS/Templates/Architecture/SpecificationTemplate.md` |
