...
| Normative References | `docs/AI-DOS/Templates/TemplateLibrary.md`; `docs/AI-DOS/Templates/TemplateIndex.md`; `docs/AI-DOS/Templates/Audit/AuditFamily.md`; `docs/AI-DOS/Templates/Standards/TPL-000-Template-Standard.md`; STD-010 when applicable; declared audit authority. |
