...
| Normative References | `docs/AI-DOS/Templates/TemplateLibrary.md`; `docs/AI-DOS/Templates/Review/README.md`; `docs/AI-DOS/Templates/Standards/TPL-000-Template-Standard.md`; STD-010 when applicable; declared subject authority. |
