...
| Normative Authority | `docs/AI-DOS/AIFramework.md`; A.1 Constitution; A.2 Product / Target Operational Boundary; Governance Atlas; Framework Governance |
...
2. route the context and invocation intent to `docs/AI-DOS/Workflows/TaskPlanner.md`;
3. accept only a conforming Task Planner selection or safe-stop record;
4. when the selection record requests an authorized Target-state activation, route it unchanged to `docs/AI-DOS/Workflows/ProjectStateUpdater.md`;
