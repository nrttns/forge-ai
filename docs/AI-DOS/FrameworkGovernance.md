...
It is policy, not navigation. Use `docs/AI-DOS/GOVERNANCE.md` to locate authority and ownership. Use this document after the relevant authority has been identified and a governance decision is required.
...
Use `docs/AI-DOS/GOVERNANCE.md` to locate ownership. Use this policy to resolve ownership conflicts.
...
`docs/AI-DOS/GOVERNANCE.md` owns:
