...
- `docs/AI/README.md`
- `docs/AI/Architecture/README.md`
- `docs/AI/Architecture/RFC/README.md`
- `docs/AI/Architecture/RFC/Runtime/README.md`
...
|:---|:---|
| `docs/AI/README.md` | Product-level navigation and product/Target separation |
| `docs/AI/Architecture/README.md` | Architecture-area topology, ownership, and truth-boundary navigation |
| `docs/AI/Architecture/RFC/README.md` | RFC-family topology and cross-family semantics |
| `docs/AI/Architecture/RFC/Runtime/README.md` | Runtime-family navigation only |
