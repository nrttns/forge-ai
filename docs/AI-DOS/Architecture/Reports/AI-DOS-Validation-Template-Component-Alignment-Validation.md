...
| Scope | `docs/AI-DOS/Templates/Validation/ValidationTemplate.md` |
| Parent Contract | `docs/AI-DOS/Templates/TemplateLibrary.md` |
| Family Entry | `docs/AI-DOS/Templates/Validation/README.md` |
...
- `docs/AI-DOS/Templates/Validation/README.md` for family navigation and boundary rules;
