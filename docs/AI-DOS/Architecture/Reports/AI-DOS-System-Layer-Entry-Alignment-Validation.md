...
- `docs/AI/System/README.md` becomes navigation-only;
- `docs/AI/System/SystemLayer.md` becomes the canonical layer contract;
- `docs/AI/README.md` exposes both navigation and contract targets;
...
docs/AI/Architecture/Reports/AI-DOS-System-Layer-Entry-Alignment-Validation.md
```
