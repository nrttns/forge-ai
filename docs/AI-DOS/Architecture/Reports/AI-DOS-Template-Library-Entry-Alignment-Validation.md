...
| Date | 2026-07-16 |
| Scope | `docs/AI/Templates/README.md`, `docs/AI/Templates/TemplateLibrary.md`, and product navigation references |
...
|:---|:---|
| `docs/AI/Templates/README.md` | Navigation, reading order, family index, selection navigation, and related links only. |
| `docs/AI/Templates/TemplateLibrary.md` | Purpose, scope, authority, non-authority, consumes, produces, selection model, family boundaries, lifecycle, produced-artifact semantics, extension rules, safe stop, and validation. |
| `docs/AI/README.md` | Product-level routing to both Template Library navigation and contract. |
