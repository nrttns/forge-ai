...
| Scope | Post-migration consistency review of the canonical `docs/AI/Architecture/` structure and the active A.0–A.6 architecture sequence. |
...
```text
docs/AI/Architecture/RFC/Boundary/
```
