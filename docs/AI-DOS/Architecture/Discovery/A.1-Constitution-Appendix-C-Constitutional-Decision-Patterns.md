...
Decision Patterns translate the principles, authority rules, source-of-truth rules, evidence expectations, violation categories, and amendment constraints defined in [A.1 — Constitution](../Constitution/A.1-Constitution.md) into repeatable decision structures.
...
- [A.1 — Constitution](../Constitution/A.1-Constitution.md)
