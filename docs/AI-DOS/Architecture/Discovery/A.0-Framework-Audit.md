...
| Normative Authority | Human Governance; `AGENTS.md`; `docs/AI-DOS/FrameworkGovernance.md` |
| Normative References | `docs/AI-DOS/Architecture/Standards/STD-010-Document-Metadata-Standard.md`; `docs/AI-DOS/Architecture/Constitution/A.1-Constitution.md`; `docs/AI-DOS/Meta/M.0-Framework-Meta-Model.md`; `docs/AI-DOS/Architecture/Standards/STD-000-Framework-Standards.md` |
...
| Related Specifications | `docs/AI-DOS/Architecture/Constitution/A.1-Constitution.md`; `docs/AI-DOS/Meta/M.0-Framework-Meta-Model.md` |
| Supersedes | None |
| Superseded By | None |
