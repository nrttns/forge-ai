...
`docs/AI/Architecture/` is the canonical architecture root for the reusable AI-DOS product. It separates constitutional authority, active Architecture RFCs, Agent Architecture, Standards, historical discovery, and review evidence.
