...
`docs/AI/Architecture/RFC/` is the canonical root for active AI-DOS Architecture RFC families. It routes readers to the owning RFC family and records cross-family authority rules. It does not own the Constitution, Standards, Agent Architecture, reports, or discovery evidence.
