...
| Normative Authority | Human Governance; `AGENTS.md`; `docs/AI-DOS/GOVERNANCE.md`; `docs/AI-DOS/FrameworkGovernance.md`; the invoking Target's Resolved Target Context (operational-state and roadmap authority) |
