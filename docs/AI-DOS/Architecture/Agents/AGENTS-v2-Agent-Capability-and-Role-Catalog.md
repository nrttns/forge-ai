...
This document refines the role and capability concepts introduced by `docs/AI-DOS/Architecture/Agents/AGENTS-v2-Architecture.md` and consumes the identity, registry, role-reference, and capability-link expectations defined by `docs/AI-DOS/Architecture/Agents/AGENTS-v2-Agent-Identity-and-Registry.md`.
