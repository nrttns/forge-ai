...
docs/AI-DOS/Architecture/Agents/AGENTS-v2-Agent-Workflow-Model.md
...
6. Prior AGENTS v2 documents define agent identity, registry, roles, capabilities, lifecycle, communication, coordination, validation, review, workflow, delegation, and escalation concepts consumed by this document.
7. Runtime Architecture remains authoritative for runtime concepts and execution-environment boundaries.
8. Engine Platform remains authoritative for engine capabilities and engine platform concepts.
...
The invoking Target's Resolved Target Context remains the operational-state and frozen-area authority; this document does not hard-code a Target-specific path for it.
...
```text
docs/AI-DOS/Architecture/Agents/AGENTS-v2-Agent-Operational-Readiness-and-Governance-Checklist.md
```
