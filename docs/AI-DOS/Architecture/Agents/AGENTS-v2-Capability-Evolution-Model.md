...
| Normative References | `docs/AI-DOS/Architecture/Agents/AGENTS-v2.md`; `docs/AI-DOS/Architecture/Agents/AGENTS-v2-Architecture.md`; applicable Agent domain authorities; `docs/AI-DOS/Architecture/RFC/Runtime/A.3-Runtime-Architecture-RFC.md`; A.4 Engine Platform; relevant A.5 specializations where applicable; `docs/AI-DOS/Architecture/Standards/STD-010-Document-Metadata-Standard.md`. |
