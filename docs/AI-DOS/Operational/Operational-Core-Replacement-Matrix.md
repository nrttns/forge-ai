...
| Normative Authority | Human Governance task instruction; `AGENTS.md`; `docs/AI-DOS/GOVERNANCE.md`; `docs/AI-DOS/FrameworkGovernance.md`; `docs/Projects/ForgeAI/Planning/ProjectStatus.md`; `docs/Projects/ForgeAI/Planning/DevelopmentPhases.md`; `docs/Roadmap/AI-DOS-Program-Architecture-Master-Roadmap-v4.md` |
