...
Parent Framework: `docs/AI-DOS/README.md`
...
`docs/AI-DOS/AIFramework.md` is the AI Framework RC2 master entry point.
...
Review independently evaluates readiness using `docs/AI-DOS/Checklists/AgentReviewChecklist.md` and any applicable command, workflow, capability, stage, phase, or governance checklist.
