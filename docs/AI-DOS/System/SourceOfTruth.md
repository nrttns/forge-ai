...
|:---|:---|:---|
| Intent classification and provider routing | `docs/AI-DOS/AIOrchestrator.md` | Invocation and Resolved Target Context |
| Candidate eligibility, priority, and selection record | `docs/AI-DOS/Workflows/TaskPlanner.md` | Target-owned objective, policy, candidates, priority values, and boundaries |
| Target-owned generation-input schema, enumeration, and minimality | `docs/AI-DOS/Workflows/TaskGenerationWorkflow.md` | A finite Target-owned generation input bound to one objective |
| Target-state mutation procedure | `docs/AI-DOS/Workflows/ProjectStateUpdater.md` | Target-owned state schema, transition policy, current values, and mutation authority |
