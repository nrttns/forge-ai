...
| Normative Authority | `docs/AI-DOS/Architecture/Constitution/A.1-Constitution.md`; `docs/AI-DOS/Architecture/RFC/Boundary/A.2-AI-DOS-Target-Project-Operational-Boundary-RFC.md`; `docs/AI-DOS/GOVERNANCE.md`; `docs/AI-DOS/FrameworkGovernance.md` |
...
- System Layer index: `docs/AI-DOS/System/README.md`
- Governance Atlas: `docs/AI-DOS/GOVERNANCE.md`
