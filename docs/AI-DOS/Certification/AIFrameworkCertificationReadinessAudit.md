...
1. `AGENTS.md`
2. `.cursorrules`
3. `docs/AI-DOS/README.md`
4. `docs/AI-DOS/AgentSystemPrompt.md`
5. `docs/AI-DOS/AIFramework.md`
6. `docs/AI-DOS/Specification/Constitution.md`
7. `docs/AI-DOS/Specification/FrameworkSpecification.md`
8. `docs/AI-DOS/Specification/RuntimeModel.md`
9. `docs/AI-DOS/Specification/GovernanceModel.md`
10. `docs/AI-DOS/Specification/ReferenceArchitecture.md`
11. `docs/AI-DOS/Specification/Terminology.md`
12. `docs/AI-DOS/AIOrchestrator.md`
13. `docs/AI-DOS/System/README.md`
14. `docs/AI-DOS/System/BootSequence.md`
15. `docs/AI-DOS/System/ExecutionSequence.md`
16. `docs/AI-DOS/System/DecisionModel.md`
17. `docs/AI-DOS/System/AuthorityModel.md`
18. `docs/AI-DOS/System/SourceOfTruth.md`
19. `docs/AI-DOS/System/ContextAssembly.md`
20. `docs/AI-DOS/Validation/README.md`
21. `docs/AI-DOS/Validation/AIFrameworkValidation.md`
22. `docs/AI-DOS/Validation/ValidationLifecycle.md`
23. `docs/AI-DOS/Validation/ValidationLevels.md`
24. `docs/AI-DOS/Validation/ValidationChecklistTemplate.md`
25. `docs/AI-DOS/Validation/ValidationCertification.md`
26. `docs/AI-DOS/Testing/README.md`
27. `docs/AI-DOS/Testing/FrameworkValidationScenarios.md`
28. `docs/AI-DOS/Testing/Scenario-01-AutonomousNextTask.md`
29. `docs/AI-DOS/Testing/Scenario-02-ImplementationTask.md`
30. `docs/AI-DOS/Testing/Scenario-03-AuditTask.md`
31. `docs/AI-DOS/Testing/Scenario-04-DocumentationTask.md`
32. `docs/AI-DOS/Testing/Scenario-05-BugFixTask.md`
33. `docs/AI-DOS/Commands/AgentTaskCommand.md`
34. `docs/AI-DOS/Commands/AgentImplementationCommand.md`
35. `docs/AI-DOS/Commands/AgentAuditCommand.md`
36. `docs/AI-DOS/Commands/AgentDocumentationCommand.md`
37. `docs/AI-DOS/Commands/AgentBugFixCommand.md`
38. `docs/AI-DOS/Workflows/TaskPlanner.md`
39. `docs/AI-DOS/Workflows/TaskGenerationWorkflow.md`
40. `docs/AI-DOS/Workflows/ProjectStateUpdater.md`
41. `docs/AI-DOS/Checklists/AgentReviewChecklist.md`
42. `docs/AI-DOS/Templates/AuditTemplate.md`
43. `docs/ProjectStatus.md`
44. `docs/AI-DOS/FrameworkGovernance.md`
...
| Operating layer | PASS | `docs/AI-DOS/System/` explicitly covers boot, execution, decision, authority, source of truth, and context assembly. |
...
- `docs/AI-DOS/AIFramework.md` is the AI Framework RC2 master entry.
- `docs/AI-DOS/Specification/Constitution.md` is the framework constitution.
...
Observation: the Certification directory did not previously exist as a visible framework map entry. This audit created `docs/AI-DOS/Certification/` and updated `docs/AI-DOS/README.md` to expose the certification evidence layer.
...
- `docs/AI-DOS/AIFramework.md` is the RC2 master framework entry.
- `docs/AI-DOS/Specification/Constitution.md` is the framework constitution.
...
| AI README references resolve | PASS | Local path references in `docs/AI-DOS/README.md` resolve after update. |
...
| Evidence | `docs/AI-DOS/Certification/` was created for this readiness audit and the AI README was updated to reference it. |
| Recommended Action | Keep future certification evidence under `docs/AI-DOS/Certification/`. |
...
2. Use this audit as the first certification evidence artifact under `docs/AI-DOS/Certification/`.
...
- `docs/AI-DOS/Specification/FrameworkSpecification.md`
- `docs/AI-DOS/Specification/RuntimeModel.md`
- `docs/AI-DOS/Specification/GovernanceModel.md`
- `docs/AI-DOS/Specification/ReferenceArchitecture.md`
- `docs/AI-DOS/Specification/Terminology.md`
...
- `docs/AI-DOS/Templates/AuditTemplate.md`
