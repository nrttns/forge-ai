...
| Review Target | `docs/AI-DOS/Templates/Project/` |
| Review Mode | Audit-only |
| Authority Chain | `AGENTS.md` → `docs/AI-DOS/AIFramework.md` → `docs/AI-DOS/Specification/Constitution.md` → `docs/ProjectStatus.md` |
...
4. `docs/AI-DOS/AIFramework.md`
5. `docs/AI-DOS/Specification/Constitution.md`
6. `docs/AI-DOS/Specification/FrameworkSpecification.md`
7. `docs/AI-DOS/Specification/ReferenceArchitecture.md`
8. `docs/AI-DOS/Templates/Project/README.md`
9. `docs/AI-DOS/Templates/Project/ProjectTemplateArchitecture.md`
10. `docs/AI-DOS/Templates/Project/GenericProjectTemplate.md`
11. `docs/AI-DOS/Templates/Project/WordPressProjectTemplate.md`
12. `docs/AI-DOS/Templates/Project/TemplateBootstrapWorkflow.md`
13. `docs/AI-DOS/Templates/Project/TemplateAdoptionChecklist.md`
14. `docs/AI-DOS/Validation/README.md`
15. `docs/AI-DOS/Validation/ValidationCertification.md`
16. `docs/AI-DOS/Testing/FrameworkValidationScenarios.md`
...
| Framework authority | `docs/AI-DOS/README.md`, `docs/AI-DOS/AIFramework.md`, `docs/AI-DOS/Specification/Constitution.md`, `docs/AI-DOS/Specification/FrameworkSpecification.md`, `docs/AI-DOS/Specification/ReferenceArchitecture.md` |
| Project template layer | `docs/AI-DOS/Templates/Project/README.md`, `docs/AI-DOS/Templates/Project/ProjectTemplateArchitecture.md`, `docs/AI-DOS/Templates/Project/GenericProjectTemplate.md`, `docs/AI-DOS/Templates/Project/WordPressProjectTemplate.md`, `docs/AI-DOS/Templates/Project/TemplateBootstrapWorkflow.md`, `docs/AI-DOS/Templates/Project/TemplateAdoptionChecklist.md` |
| Validation and certification | `docs/AI-DOS/Validation/README.md`, `docs/AI-DOS/Validation/ValidationCertification.md`, `docs/AI-DOS/Testing/FrameworkValidationScenarios.md` |
...
- AI Framework authority remains in `docs/AI-DOS/AIFramework.md` and `docs/AI-DOS/Specification/`.
...
It includes the required adoption files and directories: `AGENTS.md`, `.cursorrules`, `README.md`, `docs/ProjectStatus.md`, `docs/AI-DOS/FrameworkGovernance.md`, `docs/AI-DOS/`, `docs/DevelopmentPhases/`, `docs/Architecture/`, `src/`, `tests/`, `_reference/`, and `_wip/`.
...
- `docs/AI-DOS/` is reserved for approved framework adoption documents and must not redefine framework core.
...
- Created one certification review document under `docs/AI-DOS/Certification/`.
...
3. Require every future framework-specific template to include an extension checklist that supplements, but does not replace, `docs/AI-DOS/Templates/Project/TemplateAdoptionChecklist.md`.
...
5. Continue recording certification evidence under `docs/AI-DOS/Certification/` when framework layers are reviewed.
...
- `docs/AI-DOS/Templates/Project/ProjectTemplateArchitecture.md`
- `docs/AI-DOS/Templates/Project/GenericProjectTemplate.md`
- `docs/AI-DOS/Templates/Project/WordPressProjectTemplate.md`
- `docs/AI-DOS/Templates/Project/TemplateBootstrapWorkflow.md`
- `docs/AI-DOS/Templates/Project/TemplateAdoptionChecklist.md`
