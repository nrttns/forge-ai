...
| Normative Authority | `docs/AI/Architecture/Constitution/A.1-Constitution.md`; Human Governance |
...
| Agent architecture | `docs/AI/Architecture/Agents/` active family | Consumes Runtime and Engine authority; does not redefine them. |
| System Layer | `docs/AI/System/` | Resolves and assembles governed invocation context. |
