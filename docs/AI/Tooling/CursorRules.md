...
5. AI agents must not ask “what should I do next?” when the answer is derivable from `docs/ProjectStatus.md`, `docs/AI/AIOrchestrator.md`, and `docs/AI/Workflows/TaskPlanner.md`.
