...
If Lifecycle guidance conflicts with `docs/AI/Specification/GovernanceModel.md`, the Governance Model wins until an approved framework change updates the Lifecycle layer.
