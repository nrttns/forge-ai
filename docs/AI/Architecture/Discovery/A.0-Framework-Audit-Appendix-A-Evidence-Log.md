...
| **Impact** | High |
| **Status** | Accepted |
| **Target Document** | [A.4 — Framework Architecture](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | High |
| **Status** | Accepted |
| **Target Document** | [A.6 — Engine Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | Critical |
| **Status** | Accepted |
| **Target Document** | [A.7 — Authority Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | Critical |
| **Status** | Open |
| **Target Document** | [A.1 — Constitution](../Discovery/A.0-Framework-Audit.md#22-next-document) |
...
| **Impact** | High |
| **Status** | Accepted |
| **Target Document** | [A.8 — Ownership Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | High |
| **Status** | Open |
| **Target Document** | [A.4 — Framework Architecture](../Discovery/A.0-Framework-Audit.md#references), [A.6 — Engine Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | High |
| **Status** | Accepted |
| **Target Document** | [A.3 — Terminology](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | Critical |
| **Status** | Accepted |
| **Target Document** | [A.5 — Runtime](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | Critical |
| **Status** | Open |
| **Target Document** | [A.5 — Runtime](../Discovery/A.0-Framework-Audit.md#references), [A.6 — Engine Model](../Discovery/A.0-Framework-Audit.md#references), [A.7 — Authority Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | High |
| **Status** | Open |
| **Target Document** | [A.5 — Runtime](../Discovery/A.0-Framework-Audit.md#references), [A.6 — Engine Model](../Discovery/A.0-Framework-Audit.md#references) |
...
| **Impact** | Critical |
| **Status** | Open |
| **Target Document** | [A.1 — Constitution](../Discovery/A.0-Framework-Audit.md#22-next-document) and all subsequent Framework Core documents. |
