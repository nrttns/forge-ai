...
| **Status** | Planned |
| **Canonical References** | [A.1 — Constitution](../Discovery/A.0-Framework-Audit.md#22-next-document) |
...
| **Status** | Active |
| **Canonical References** | Existing Runtime documentation; [A.5 — Runtime](../Discovery/A.0-Framework-Audit.md#references). |
