...
This document refines the communication and coordination concerns introduced by `docs/AI/Architecture/Agents/AGENTS-v2-Architecture.md`, consumes identity and registry expectations from `docs/AI/Architecture/Agents/AGENTS-v2-Agent-Identity-and-Registry.md`, consumes capability and role expectations from `docs/AI/Architecture/Agents/AGENTS-v2-Agent-Capability-and-Role-Catalog.md`, and consumes lifecycle and governance boundaries from `docs/AI/Architecture/Agents/AGENTS-v2-Agent-Lifecycle-and-Governance-Boundaries.md`.
...
```text
docs/AI/Architecture/Agents/AGENTS-v2-Agent-Task-Delegation-and-Handoff.md
```
