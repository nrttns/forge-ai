...
This document refines the agent identity and registry portions of `docs/AI/Architecture/Agents/AGENTS-v2-Architecture.md`. It does not implement a registry and does not activate runtime, multi-agent, swarm, platform-adapter, or Engine RFC work.
