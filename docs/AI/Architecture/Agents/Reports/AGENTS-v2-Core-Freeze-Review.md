...
Capability Artifact Disposition Note: this review remains historical evidence. Current navigation uses `docs/AI/Architecture/Agents/AGENTS-v2-Capability-Maturity-Model.md` and `docs/AI/Architecture/Agents/AGENTS-v2-Capability-Evolution-Model.md`; references to their review-time planning roles are preserved only as historical context.
...
| `docs/AI/Architecture/Agents/AGENTS-v2-Capability-Maturity-Model.md` | Current successor path for the review-time planning phases artifact; now the AGENTS v2 capability maturity/readiness model. |
| `docs/AI/Architecture/Agents/AGENTS-v2-Capability-Evolution-Model.md` | Current successor path for the review-time strategic roadmap artifact; now the AGENTS v2 capability dependency/evolution model. |
