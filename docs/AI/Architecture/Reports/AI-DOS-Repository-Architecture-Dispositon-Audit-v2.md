...
| Normative References | `docs/AI/System/TargetRepositoryResolution.md`; `docs/AI/System/SystemLayerFreeze.md`; `docs/AI/Architecture/Reports/Target-Project-Path-Resolution.md`; `docs/AI/Architecture/Reports/AI-DOS-Repository-Rationalization-Audit.md`; `docs/AI/Architecture/Reports/AI-DOS-Repository-Classification-Audit-v1.0.md`; `docs/Projects/ForgeAI/Planning/ProjectStatus.md`; `docs/Projects/ForgeAI/Planning/DevelopmentPhases.md`; `docs/Roadmap/AI-DOS-Program-Architecture-Master-Roadmap-v4.md`; `docs/AI/Architecture/Standards/STD-003-Terminology-Standard.md`; `docs/AI/Architecture/Standards/STD-010-Document-Metadata-Standard.md` |
...
| ProjectStatus | `docs/Projects/ForgeAI/Planning/ProjectStatus.md` |AI-DOS Target Project Governance | LiveAI-DOS operational state. | Live project state, not architecture. | Live operational state. |AI-DOS self-hosting project truth. | Consumed by AI-DOS while self-hosting. | KEEP_SELF_HOSTING |
...
| ProjectStatus |AI-DOS Target Project Governance |AI-DOS Target Project / Active operational state | KEEP_SELF_HOSTING | `docs/Projects/ForgeAI/Planning/ProjectStatus.md` |
...
|:---|:---|:---|
| ProjectStatus | Target Project live operational state, not universal AI-DOS Framework architecture. | `docs/Projects/ForgeAI/Planning/ProjectStatus.md` |
| DevelopmentPhases |AI-DOS Target Project phase sequence, not universal external Target Repository phase authority. | `docs/Projects/ForgeAI/Planning/DevelopmentPhases.md` |
