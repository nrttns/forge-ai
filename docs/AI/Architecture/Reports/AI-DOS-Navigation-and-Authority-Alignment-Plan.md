...
`docs/AI/Architecture/README.md` owns architecture-domain navigation only. It shall identify:
...
`docs/AI/Architecture/RFC/README.md` owns the complete Architecture RFC inventory and reading order. It shall:
...
`docs/AI/Architecture/RFC/Runtime/README.md` owns Runtime-family navigation only. It shall:
