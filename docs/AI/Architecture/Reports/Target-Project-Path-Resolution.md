...
| Related Specifications | `docs/AI/Architecture/Reports/AI-DOS-Repository-Rationalization-Audit.md`; `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md`. |
| Supersedes | None |
| Superseded By | None |
...
The scan of materially relevant active documents found 139 occurrences of the requested path patterns outside historical report evidence. These occurrences are not all defects.AI-DOS self-hosting navigation,AI-DOS repository-specific governance, and historical references may remain valid when labeled or scoped. General Operational, System, Command, Workflow, and Template documents should not impose `docs/DevelopmentPhases/ProjectStatus.md`, `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md`, or `docs/ProjectStatus.md` as universal target-project paths.
...
|:---|:---|:---|:---|:---|:---|:---|
| `README.md` | `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md` | Root repository overview and AI-DOS self-hosting navigation | `VALID_FORGE_SELF_HOSTING` | Keep AI-DOS self-hosting paths; preserve existing external target-project portability note. | No | No immediate correction required. |
| `docs/AI/README.md` | `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md` | AI directory navigation | `VALID_FORGE_SELF_HOSTING` | Keep only when scoped toAI-DOS self-hosting; external target projects resolve through target root `AGENTS.md`. | No | Optional label strengthening in non-frozen normalization. |
...
| `docs/AI/System/README.md` | `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md` | System Layer index | `FROZEN_DOCUMENT_REQUIRING_CONTROLLED_UNFREEZE` | If unfrozen, map System Layer references to target-declared logical variables and label AI-DOS self-hosting physical paths. | Yes | Controlled Human Governance unfreeze required. |
...
| `docs/AI/Commands/AgentTaskCommand.md` | `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md` | Reusable command | `INVALID_GENERAL_FRAMEWORK_HARDCODE` | Resolve target task context from target root `AGENTS.md` before applyingAI-DOS general command rules. | No | Non-frozen refactor candidate. |
...
| `docs/AI/Architecture/Reports/AI-DOS-Repository-Rationalization-Audit.md` | `docs/DevelopmentPhases/ProjectStatus.md`; `docs/DevelopmentPhases/ForgeAI-DevelopmentPhases.md`; `docs/ProjectStatus.md` | Historical audit/report evidence | `HISTORICAL_REFERENCE` | Preserve as evidence; do not rewrite as part of target-path normalization. | No | No correction in this task. |
