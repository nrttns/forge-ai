...
| Related Specifications | `docs/AI/Architecture/RFC/Runtime/README.md`; `docs/AI/Architecture/RFC/EnginePlatform/A.4-Engine-Architecture-RFC.md` |
| Supersedes | None |
| Superseded By | None |
...
9. `docs/AI/Architecture/Reports/AI-DOS-Blueprint-v1.0-RFC.md` — v1.0 blueprint providing architectural context.
