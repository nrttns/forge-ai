...
| Normative Authority | Human Governance; `docs/AI/Architecture/Constitution/A.1-Constitution.md`; `docs/AI/Architecture/RFC/Boundary/A.2-AI-DOS-Target-Repository-Operational-Boundary.md`; `docs/AI/GOVERNANCE.md`; `docs/AI/FrameworkGovernance.md` |
