...
7. `docs/AI/Architecture/RFC/Runtime/A.3-Runtime-Architecture-RFC.md` — Runtime architecture defining the execution host environment.
8. `docs/AI/Architecture/RFC/EnginePlatform/A.4-Engine-Architecture-RFC.md` — Parent Engine Architecture RFC.
9. `docs/AI/Architecture/RFC/EnginePlatform/A.4.1-Engine-Kernel-RFC.md` — Engine Kernel defining registration, discovery, lifecycle, invocation, and parallel-system prevention.
