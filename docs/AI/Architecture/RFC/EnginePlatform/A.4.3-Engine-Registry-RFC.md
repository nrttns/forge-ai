...
5. **`docs/AI/Architecture/Constitution/A.1-Constitution.md`** — Constitutional authority governing framework-level principles, rights, and structural constraints.
...
5. `docs/AI/Architecture/Constitution/A.1-Constitution.md` — Constitutional principles.
...
11. `docs/AI/Architecture/RFC/Runtime/A.3-Runtime-Architecture-RFC.md` — Runtime architecture.
12. `docs/AI/Architecture/RFC/EnginePlatform/A.4-Engine-Architecture-RFC.md` — Engine architecture.
13. `docs/AI/Architecture/RFC/EnginePlatform/A.4.1-Engine-Kernel-RFC.md` — Engine Kernel.
14. `docs/AI/Architecture/RFC/EnginePlatform/A.4.2-Engine-Contract-RFC.md` — Engine Contract.
...
| A.1 Constitution | `docs/AI/Architecture/Constitution/A.1-Constitution.md` | Normative Reference |
