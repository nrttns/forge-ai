...
| Normative Authority | Human Governance; `docs/AI/Architecture/Constitution/A.1-Constitution.md`; `docs/AI/Templates/TemplateLibrary.md` |
| Created | 2026-07-09 |
...
| Normative References | `docs/AI/Templates/TemplateLibrary.md`; `docs/AI/Templates/TemplateIndex.md`; `docs/AI/Architecture/Standards/STD-010-Document-Metadata-Standard.md` |
